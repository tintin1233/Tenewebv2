        ...
        <div class="flex  flex-col gap-2" x-data="{ toggle: false }">
            <div class="border-y border-gray-200 p-2 flex  items-center gap-2  justify-between capitalize">
                <h1 class="input-generic-label flex items-center gap-2">
                    <span> Questions </span> <span>{{ $announcement->announcementFeeds()->count() }}</span>
                </h1>
                        ...
                        <div class="flex justify-between">
                            ...
                            <div class="flex items-center gap-2">
                                ...
                                @if ($comment->user->id === Auth::user()->id)
                                    <button onclick="delete_modal_{{$comment->id}}.showModal()" class="btn btn-error btn-sm">
                                        Delete
                                    </button>
                                @endif
                                ...
                                <dialog id="delete_modal_{{$comment->id}}" class="modal">
                                    <div class="modal-box">
                                        ...
                                        <div class="flex items-center gap-2 ">
                                            <form action="{{route('tenant.announcement-feeds.destroy', ['announcement_feed' => $comment->id])}}" method="post">
                                                @csrf
                                                @method('DELETE')
                        ...
                        <div class="flex flex-col gap-2 bg-gray-100 rounded-lg p-2  grow" x-data="{ toggleId: null }">
                            ...
                            <div class="flex justify-between">
                                ...
                                @if ($reply->user->id === Auth::user()->id)
                                    <button onclick="reply_modal_delete_{{$reply->id}}" class="btn btn-error btn-sm">
                                        Delete
                                    </button>
                                @endif
