<x-dashboard.admin.base>
    ...
    <div class="panel p-2">
        <form action="{{route('admin.master-list.update', ['master_list' => $masterList->id])}}" method="post" class="w-full h-full flex flex-col gap-2" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            <div class="flex gap-5">
                ...
                <div class="flex flex-col gap-2">
                    ...
                    <div class="flex flex-col gap-2">
                        ...
                        <select name="room" class="select select-primary w-full select-sm text-sm" value="{{$masterList->room_number}}">
