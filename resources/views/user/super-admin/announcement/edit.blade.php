<x-dashboard.super-admin.base>
    ...
    <x-dashboard.page-label title="Update Announcement" :back_url="route('super-admin.announcements.index')" />

    <div class="panel p-2 flex flex-col gap-2">

        <form action="{{ route('super-admin.announcements.update', ['announcement' => $announcement->id]) }}" enctype="multipart/form-data" method="post" class="flex flex-col gap-2 w-full h-full">
            @csrf
            @method('put')
