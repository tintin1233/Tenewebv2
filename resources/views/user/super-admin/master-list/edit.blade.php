<x-dashboard.super-admin.base>
    ...
    <x-dashboard.page-label :back_url="route('super-admin.master-list.index')" title="Edit Master List" />

    <div class="panel p-2">
        <form action="{{route('super-admin.master-list.update', ['master_list' => $masterList->id])}}" method="post" class="w-full h-full flex flex-col gap-2" enctype="multipart/form-data">
            @csrf
            @method('PUT')
                ...
                <div class="flex flex-col gap-2">
                    <div class="grid grid-cols-3 grid-flow-row gap-2">
                        <div class="flex flex-col gap-2">
                            ...
                            <input type="text" name="last_name" class="input-generic"" value="{{$masterList->last_name}}">
                        ...
                        <div class="flex flex-col gap-2">
                            ...
                            <input type="text" name="first_name" class="input-generic" value="{{$masterList->first_name}}">
                        ...
                        <div class="flex flex-col gap-2">
                            ...
                            <input type="text" name="middle_name" class="input-generic" value="{{$masterList->middle_name}}">
                    ...
                    <div class="flex flex-col gap-2">
                        ...
                        <input type="number" name="age" class="input-generic"" value="{{$masterList->age}}">
                        @if ($errors->has('age'))
                    ...
                    <div class="flex flex-col gap-2" x-data="tenementRooms" x-init="tenementsData({{json_encode($tenements)}})">
                        <div class="flex flex-col gap-2">
                            ...
                            <select @change="selectTenement($event)" name="tenement" class="select select-primary w-full select-sm text-sm">
                        ...
                        <div class="flex flex-col gap-2" x-show="tenement">
                         ...
                         <select name="room" class="select select-primary w-full select-sm text-sm">
                                ...
                                <template x-for="room in tenement?.rooms" :key="room.id">
                    ...
                    <div class="flex flex-col gap-2">
                        ...
                        <select name="gender" class="select select-primary w-full select-sm text-sm" value="{{$masterList->gender}}">
                    ...
                    <div class="flex flex-col gap-2">
                        ...
                        <input type="number" name="contact_no" class="input-generic"" value="{{$masterList->contact_no}}">
